...
mod tests {
    ...
    fn test_1() {
        ...
        assert!(!word_dictionary.search("pad".to_owned())); // return False
        assert!(word_dictionary.search("bad".to_owned())); // return True
        assert!(word_dictionary.search(".ad".to_owned())); // return True
        assert!(word_dictionary.search("b..".to_owned())); // return True
    }
    ...
    fn test_2() {
        ...
        word_dictionary.add_word("zxxxx".to_owned());
        word_dictionary.add_word("qeba".to_owned());
        word_dictionary.add_word("qes".to_owned());

        assert!(word_dictionary.search("...".to_owned()));
    }
    ...
    fn test_3() {
        ...
        word_dictionary.add_word("jbtjyj".to_owned());
        word_dictionary.add_word("qsibzxao".to_owned());
        word_dictionary.add_word("qes".to_owned());

        assert!(word_dictionary.search("qes".to_owned()));
    }
    #[test]
    fn test_4() {
        let mut word_dictionary = WordDictionary::new();

        word_dictionary.add_word("a".to_owned());
        word_dictionary.add_word("a".to_owned());

        assert!(word_dictionary.search(".".to_owned()));
        assert!(word_dictionary.search("a".to_owned()));
        assert!(!word_dictionary.search("aa".to_owned()));
        assert!(word_dictionary.search("a".to_owned()));
        assert!(!word_dictionary.search(".a".to_owned()));
        assert!(!word_dictionary.search("a.".to_owned()));
    }
